...
class Client extends CI_Controller
{
	...
	public function client_target()
	{
		...
		$data['client_target_data'] = $this->Client_model->get_task_setup_client_table();
	...
	{
		$data = $this->Client_model->get_view_client_target_data();
		echo json_encode($data);
	}
	...
	{
		$data = $this->Client_model->target_form_client_data();
		echo json_encode($data);
	}

	public function insert_client_target_details()
	{
		$data = $this->Client_model->insert_client_target_details();
		echo json_encode($data);
	}
