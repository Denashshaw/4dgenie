<?php
 class Client_model extends CI_Model
 {
  ...
  {
    $deprt_res = $this->db->select('id')->from('department')->where('department', $_SESSION['department'])->get()->row();
  ...
  {
    return $this->db->select('*')->from('client_task')->get()->result();
  }
  ...
  {
    return $this->db->select('client_task.task, client_sub_task.sub_task, client_sub_task.id')->from('client_task')
