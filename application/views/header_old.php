  ...
  <ul class="menu">
    ...
    <?php if($userdata['role']=='admin' || $userdata['role']=='supervisor'){?>
        ...
        <div class="dropdown_rep">
          ...
          <li><a class="<?php  if($actlinks == "TicketReport") echo "active";?>" href="<?php echo base_url();?>TicketReport"><i class="fa fa-arrow-right" aria-hidden="true"></i> IT Help Desk Report</a></li>
          <?php } ?>
        </div>
      <?php } ?>
